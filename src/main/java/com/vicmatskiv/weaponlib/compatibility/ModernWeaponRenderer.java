...
import com.vicmatskiv.weaponlib.compatibility.ModernWeaponRenderer.StateDescriptor;
...
public abstract class ModernWeaponRenderer extends ModelSourceRenderer implements IBakedModel {
    ...
    private class WeaponItemOverrideList extends ItemOverrideList {
        ...
        public IBakedModel handleItemState(IBakedModel originalModel, ItemStack stack, World world,
            ...
            ModernWeaponRenderer.this.itemStack = stack;
            ModernWeaponRenderer.this.player = entity;
    ...
    protected ModernWeaponRenderer (WeaponRenderer.Builder builder) {
...
//    protected abstract StateDescriptor getStateDescriptor(EntityLivingBase player, ItemStack itemStack);
    ...
    public void renderItem()
    {
    	...
    	//System.out.println(BBLoader.loadAnimationData("HKgrip.animation.json", "animation.HKgrip.reload2", "bone4").bbTransition);
        GL11.glPushMatrix();
        ...
        case FIRST_PERSON_RIGHT_HAND: case FIRST_PERSON_LEFT_HAND:
          ...
          //  AnimationData anm = BBLoader.loadAnimationData("fuckyou3.animation.json", "animation.M4A1.test", "main");
			
          // System.out.println(anm.bbTransition.get(2.4f).getTranslation());
           
            
           //System.out.println(anm.bbTransition.get(1.5f).getTranslation());
            AnimationData anm = BBLoader.loadAnimationData("real.animation.json", "animation.M4A1.reload", "main");
           ...
           // System.out.println(anm.bbTransition);
            ...
            float zOffset = -0.0f;
            float yOff = 1.0f;
            GlStateManager.translate(-xOff, -yOff, -zOffset);
            
            
           // GlStateManager.rotate(20f*((player.ticksExisted%40)/40f), 1f, 0f, 0.0f);
           ...
           // GlStateManager.rotate(-FuckMyLife.instance.timer*45, 0, 1, 0);
            GlStateManager.translate(xOff, yOff, zOffset);
            
           
            
            
          // anm.bbTransition.get(1.5f).directTransform();
...
//        GlStateManager.enableLighting();
    ...
    static <T> void renderLeftArm(EntityLivingBase player, RenderContext<T> renderContext,
        ...
        float debugValue = (float) (-90f*((player.ticksExisted%20)/20.0));
        
        GL11.glPushMatrix();
     
        
        AnimationData anm = BBLoader.loadAnimationData("real.animation.json", "animation.M4A1.reload", "lefthand");
		FuckMyLife.instance.bbMap.clear();
        for(Entry<Float, BlockbenchTransition> tranny : anm.bbTransition.entrySet()) {
			FuckMyLife.instance.bbMap.put(tranny.getKey(), tranny.getValue());
		}
     ...
     FuckMyLife.instance.timer = 0f;
        ...
        GL11.glTranslatef(0.1f, -1.3f, 0.5f);
        ...
        GlStateManager.rotate(-8.2f, 1, 0, 0);
        GlStateManager.rotate(-23.7f, 0, 1, 0);
        GlStateManager.rotate(57.7f, 0, 0, 1);
        ...
        yO = 0f;
        zO = 0f;
        float scale = (float) 3.0f;
        GlStateManager.translate(-xO, -yO, -zO);
        GL11.glScalef(scale, scale*1.0f, scale);
        GlStateManager.translate(xO, yO, zO);
