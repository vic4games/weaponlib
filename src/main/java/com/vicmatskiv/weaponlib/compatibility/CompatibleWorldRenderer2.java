...
public class CompatibleWorldRenderer2 extends EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private CompatibleRenderGlobal renderglobal;

    public CompatibleWorldRenderer2(Minecraft p_i45076_1_, IResourceManager p_i45076_2_)
    {
    	super(p_i45076_1_, p_i45076_2_);
    	this.renderglobal = new CompatibleRenderGlobal(p_i45076_1_);
    	renderglobal.setWorldAndLoadRenderers(p_i45076_1_.theWorld);
     ...
     */
    public void updateRenderer(EntityLivingBase renderViewEntity)
    {
        ...
        {
            this.renderViewEntity = renderViewEntity; //this.mc.thePlayer;
        }

        f = this.mc.theWorld.getLightBrightness(MathHelper.floor_double(this.renderViewEntity.posX), MathHelper.floor_double(this.renderViewEntity.posY), MathHelper.floor_double(this.renderViewEntity.posZ));
    ...
    public void getMouseOver(float p_78473_1_)
    {
        if (this.renderViewEntity != null)
        {
            if (this.mc.theWorld != null)
            {
                ...
                this.mc.objectMouseOver = this.renderViewEntity.rayTrace(d0, p_78473_1_);
                double d1 = d0;
                Vec3 vec3 = this.renderViewEntity.getPosition(p_78473_1_);
                ...
                Vec3 vec31 = this.renderViewEntity.getLook(p_78473_1_);
                Vec3 vec32 = vec3.addVector(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0);
                this.pointedEntity = null;
                Vec3 vec33 = null;
                float f1 = 1.0F;
                List list = this.mc.theWorld.getEntitiesWithinAABBExcludingEntity(this.renderViewEntity, this.renderViewEntity.boundingBox.addCoord(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0).expand((double)f1, (double)f1, (double)f1));
                double d2 = d1;
                ...
                for (int i = 0; i < list.size(); ++i)
                {
                    ...
                    if (entity.canBeCollidedWith())
                    {
                        ...
                        else if (movingobjectposition != null)
                        {
                            ...
                            if (d3 < d2 || d2 == 0.0D)
                            {
                                if (entity == this.renderViewEntity.ridingEntity && !entity.canRiderInteract())
                                {
                                    if (d2 == 0.0D)
                                    {
                                        this.pointedEntity = entity;
    ...
    {
        if (/*mc*/ this.renderViewEntity instanceof EntityPlayerSP)
        {
            EntityPlayerSP entityplayersp = (EntityPlayerSP)this.renderViewEntity;
    ...
    private float getFOVModifier(float p_78481_1_, boolean p_78481_2_)
    {
        ...
        {
            EntityLivingBase entityplayer = (EntityLivingBase)this.renderViewEntity;
            float f1 = 70.0F;
            ...
            Block block = CompatibleActiveRenderInfo.getBlockAtEntityViewpoint(this.mc.theWorld, entityplayer, p_78481_1_);
    ...
    {
        EntityLivingBase entitylivingbase = this.renderViewEntity;
    ...
    {
        if (this.renderViewEntity instanceof EntityPlayer)
        {
            EntityPlayer entityplayer = (EntityPlayer)this.renderViewEntity;
    ...
    private void orientCamera(float p_78467_1_)
    {
        ...
        this.cloudFog = this.renderglobal.hasCloudFog(d0, d1, d2, p_78467_1_);
    }
    ...
    private void renderHand(float p_78476_1_, int p_78476_2_)
    {
        if (this.debugViewDirection <= 0)
        {
            ...
            if (this.mc.gameSettings.thirdPersonView == 0 && !this.renderViewEntity.isPlayerSleeping() && !this.mc.gameSettings.hideGUI && !this.mc.playerController.enableEverythingIsScrewedUpMode())
            {
            ...
            if (this.mc.gameSettings.thirdPersonView == 0 && !this.renderViewEntity.isPlayerSleeping())
            {
    ...
    public void updateCameraAndRender(float p_78480_1_)
    {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                {
                    this.renderWorld(this.renderViewEntity, p_78480_1_, this.renderEndNanoTime + (long)(1000000000 / i1));
                }
                else
                {
                    this.renderWorld(this.renderViewEntity, p_78480_1_, 0L);
                }
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                catch (Throwable throwable)
                {
                    ...
                    crashreportcategory.addCrashSectionCallable("Screen name", new Callable()
                    {
                        ...
                        public String call()
                        {
                            return CompatibleWorldRenderer2.this.mc.currentScreen.getClass().getCanonicalName();
                        }
                    });
                    ...
                    crashreportcategory.addCrashSectionCallable("Screen size", new Callable()
                    {
                        ...
                        public String call()
                        {
                            return String.format("Scaled: (%d, %d). Absolute: (%d, %d). Scale factor of %d", new Object[] {Integer.valueOf(scaledresolution.getScaledWidth()), Integer.valueOf(scaledresolution.getScaledHeight()), Integer.valueOf(CompatibleWorldRenderer2.this.mc.displayWidth), Integer.valueOf(CompatibleWorldRenderer2.this.mc.displayHeight), Integer.valueOf(scaledresolution.getScaleFactor())});
                        }
                    });
    ...
    public void renderWorld(EntityLivingBase firstPersonEntityLiving, float p_78471_1_, long p_78471_2_)
    {
        this.mc.mcProfiler.startSection("lightTex");
...
//        if (this.renderViewEntity == null)
//        {
//            this.renderViewEntity = firstPersonEntityLiving; //this.mc.thePlayer;
//        }
        
        this.renderViewEntity = firstPersonEntityLiving;

        this.mc.mcProfiler.endStartSection("pick");
        this.getMouseOver(p_78471_1_);
        EntityLivingBase entitylivingbase = this.renderViewEntity;
        //CompatibleRenderGlobal renderglobal = this.renderGlobal;
        //renderglobal.setRenderViewEntity(entitylivingbase);
        ...
        for (int j = 0; j < 2; ++j)
        {
            ...
            CompatibleActiveRenderInfo.updateRenderInfo(this.renderViewEntity, this.mc.gameSettings.thirdPersonView == 2);
            ...
            renderglobal.clipRenderersByFrustum(frustrum, p_78471_1_);

            if (j == 0)
            {
                this.mc.mcProfiler.endStartSection("updatechunks");

                while (!renderglobal.updateRenderers(entitylivingbase, false) && p_78471_2_ != 0L)
                {
...
//            }
    ...
    private void updateFogColor(float p_78466_1_)
    {
        ...
        Vec3 vec3 = worldclient.getSkyColor(this.renderViewEntity, p_78466_1_);
        ...
        Block block = CompatibleActiveRenderInfo.getBlockAtEntityViewpoint(this.mc.theWorld, entitylivingbase, p_78466_1_);
        float f10;
    ...
    private void setupFog(int p_78468_1_, float p_78468_2_)
    {
        ...
        else
        {
            ...
            GL11.glNormal3f(0.0F, -1.0F, 0.0F);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            Block block = CompatibleActiveRenderInfo.getBlockAtEntityViewpoint(this.mc.theWorld, entitylivingbase, p_78468_2_);
            float f1;
