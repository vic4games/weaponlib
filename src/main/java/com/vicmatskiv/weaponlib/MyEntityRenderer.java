...
public class MyEntityRenderer extends EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public MyEntityRenderer(Minecraft p_i45076_1_, IResourceManager p_i45076_2_)
    {
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                catch (Throwable throwable)
                {
                    ...
                    crashreportcategory.addCrashSectionCallable("Screen name", new Callable()
                    {
                        ...
                        public String call()
                        {
                            return MyEntityRenderer.this.mc.currentScreen.getClass().getCanonicalName();
                        }
                    });
