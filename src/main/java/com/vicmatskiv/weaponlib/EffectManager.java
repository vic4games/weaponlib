...
public interface EffectManager {
    ...
    void spawnFlashParticle(EntityLivingBase player, float flashIntensity, float flashScale, float xOffset, float yOffset);

    void spawnExplosionSmoke(double posX, double posY, double posZ, double motionX, double motionY, double motionZ,
            float scale, int maxAge, Behavior behavior, ResourceLocation textureResource);
