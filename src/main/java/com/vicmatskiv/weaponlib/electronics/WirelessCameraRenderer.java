...
public class WirelessCameraRenderer extends CompatibleEntityRenderer {
    ...
    public WirelessCameraRenderer(Item p_i1259_1_, int p_i1259_2_)
    {
    ...
    //        @Override
    //        protected void doCompatibleRender(Entity entity, double x, double y, double z, float entityYaw,
    //            float partialTicks) {
    //        // TODO Auto-generated method stub
    //        
    //        }
    public void doCompatibleRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
