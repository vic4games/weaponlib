...
public class RenderVehicle extends CompatibleEntityRenderer
{
    ...
    protected ModelBase modelBoat = new ModelVehicle();
...
//        super(renderManagerIn);
    ...
    public void doCompatibleRender(Entity entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        this.setupRotation(entityVehicle, entityYaw, partialTicks);
...
//        super.doCompatibleRender(entity, x, y, z, entityYaw, partialTicks);
    }

    public void setupRotation(EntityVehicle p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
    ...
    {
        return BOAT_TEXTURES[((EntityVehicle) entity).getBoatType().ordinal()];
    }
    ...
    public void renderMultipass(EntityVehicle p_188300_1_, double p_188300_2_, double p_188300_4_, double p_188300_6_, float p_188300_8_, float p_188300_9_)
    {
        GlStateManager.pushMatrix();
