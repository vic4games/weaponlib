...
public class ModelVehicle extends ModelBase implements IMultipassModel
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        EntityVehicle entityboat = (EntityVehicle)entityIn;
    ...
    protected void renderPaddle(EntityVehicle boat, int paddle, float scale, float limbSwing)
    {
