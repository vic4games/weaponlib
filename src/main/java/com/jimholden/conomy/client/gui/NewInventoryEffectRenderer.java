...
import com.jimholden.conomy.containers.ExtendedInventoryContainer;
...
public abstract class NewInventoryEffectRenderer extends ExtendedInventoryContainer {

	/** True if there is some potion effect to display */
    protected boolean hasActivePotionEffects;
    
    
	public NewInventoryEffectRenderer(Container inventorySlotsIn) {
