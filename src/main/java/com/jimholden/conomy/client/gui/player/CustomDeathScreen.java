...
public class CustomDeathScreen extends GuiScreen
{
    /** The integer value containing the number of ticks that have passed since the player's death */
    private int enableButtonsTimer;
    private final ITextComponent causeOfDeath;

    public CustomDeathScreen(@Nullable ITextComponent causeOfDeathIn)
    {
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            //   this.mc.displayGuiScreen(null);
                ...
                ModEventClientHandler.blackLock = false;
                ModEventClientHandler.blackOutTime = 0;
           //     ModEventClientHandler.lock = false;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        //this.draw
        //this.drawTexturedModalRect(0, 0, this.width, this.height, mouseX, mouseY);
