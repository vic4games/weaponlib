...
public class CheckButton extends ConomyButton implements ICheckable{
	...
	public CheckButton(int buttonId, double x, double y, IInfoDisplay info, double size, GuiPage gp) {
	...
	public CheckButton(int buttonId, double x, double y, IInfoDisplay info, double size) {
