...
import com.jimholden.conomy.blocks.tileentity.TileEntitySyringeLoader;
...
import com.jimholden.conomy.containers.ContainerSyringeLoader;
...
public class GuiSyringeLoader extends GuiContainer {
	
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/guisyringeloader.png");
	FontRenderer fr = Minecraft.getMinecraft().fontRenderer;
	private final TileEntitySyringeLoader tileentity;
	public GuiButton startReaction;
	public GuiButton autoMode;
	
	
	
	public GuiSyringeLoader(EntityPlayer player, TileEntitySyringeLoader tileentity, MinecraftServer server) {
		super(new ContainerSyringeLoader(player.inventory, tileentity));
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		int progress = (int) ((int) 112-(112*((float) this.tileentity.timer/this.tileentity.maxTime)));
		
		//this.drawTexturedModalRect(68, 19, 0, 166, 19, 44);
		
		this.drawTexturedModalRect(8, 52, 0, 166, 112-progress, 5);
