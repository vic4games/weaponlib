...
import com.jimholden.conomy.collision.GJKResult;
import com.jimholden.conomy.collision.OBBCollider;
import com.jimholden.conomy.collision.OreintedBB;
	...
	public void simulate(double x, double y, double z, double dt) {
		...
		for(Point p : points) {
			if(!p.locked) {
				...
				Vec3d realPos = worldPos.add(p.pos.scale(1));
