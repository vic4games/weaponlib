...
public class RenderEntityTrader extends RenderLiving<EntityLiving> {
	
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/entity/deer.png");


	public RenderEntityTrader(RenderManager manager) {
		super(manager, new DeerModel(), 0.5F);
	}
	
	public RenderEntityTrader(RenderManager rendermanagerIn, ModelBase modelbaseIn, float shadowsizeIn) {
