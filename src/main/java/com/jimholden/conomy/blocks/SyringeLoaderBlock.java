...
public class SyringeLoaderBlock extends Block3D implements ITileEntityProvider {
	...
	public SyringeLoaderBlock(String name, Material material) {
		super(name, material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(Main.instance, Reference.GUI_SYRINGELOADER, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new TileEntitySyringeLoader();
	}
