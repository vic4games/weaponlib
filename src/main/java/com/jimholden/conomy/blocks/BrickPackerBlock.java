...
public class BrickPackerBlock extends Block3D implements ITileEntityProvider {
	...
	public BrickPackerBlock(String name, Material material) {
		super(name, material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(Main.instance, Reference.GUI_BRICKPACKER, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new TileEntityBrickPacker();
	}
