...
public class CompoundMixerBlock extends Block3D implements ITileEntityProvider {
	...
	public CompoundMixerBlock(String name, Material material) {
		super(name, material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(Main.instance, Reference.GUI_COMPOUNDMIXER, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new TileEntityCompoundMixer();
	}
