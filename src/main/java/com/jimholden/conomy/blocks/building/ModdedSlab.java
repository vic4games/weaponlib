...
public abstract class ModdedSlab extends BlockSlab implements IHasModel {
    ...
    public static class Double extends ModdedSlab
        {
    ...
    public static class Half extends ModdedSlab
        {
