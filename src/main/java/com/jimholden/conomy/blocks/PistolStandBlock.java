...
public class PistolStandBlock extends Block3D implements ITileEntityProvider {
	...
	public PistolStandBlock(String name, Material material) {
		super(name, material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(Main.instance, Reference.GUI_PISTOLSTAND, worldIn, pos.getX(), pos.getY(), pos.getZ());
		
		/*
		TileEntityPistolStand te = (TileEntityPistolStand) worldIn.getTileEntity(pos);
		ItemStack stack = playerIn.getHeldItem(hand);
		if(stack.isEmpty()) {
			if(!worldIn.isRemote) {
				playerIn.addItemStackToInventory(te.handler.getStackInSlot(0));
			}
			
		} else {
			
			te.handler.setStackInSlot(0, stack);
		} */
		
		
		
		//System.out.println("Yes, activated.");
		//System.out.println(worldIn.isRemote);
		//System.out.println(playerIn.world.isRemote);
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		// TODO Auto-generated method stub
		return new TileEntityPistolStand();
	}
