...
public class GeneratorBlock extends Block3D implements ITileEntityProvider {
	...
	public ArrayList<TileEntityGenerator> nodes = new ArrayList<TileEntityGenerator>();
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(Main.instance, Reference.GUI_GENERATOR, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
