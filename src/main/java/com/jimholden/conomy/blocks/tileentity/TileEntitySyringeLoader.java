...
public class TileEntitySyringeLoader extends TileEntity implements ITickable, IMachine {
	...
	public TileEntitySyringeLoader() {
	}
	...
	public boolean canStart() {
		...
		if(compoundStack.getItem() instanceof ItemDrugPowder && packingStack.getItem() instanceof ItemDrugPowder) {
			if(((ItemDrugPowder) packingStack.getItem()).getDrugType(packingStack) != 4) return false;
			
			ItemStack stackBrick = DrugComponentTool.makePill(compoundStack, packingStack);
	...
	public void produce() {
		...
		if(compoundStack.getItem() instanceof ItemDrugPowder && packingMaterial.getItem() instanceof ItemDrugPowder) {
			if(((ItemDrugPowder) packingMaterial.getItem()).getDrugType(packingMaterial) != 4) return;
			...
			*/
			...
			ItemStack stackBrick = DrugComponentTool.makePill(compoundStack, packingMaterial);
