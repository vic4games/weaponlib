...
public class MOLLEPlateCarrier extends ModelBiped {
	...
	public MOLLEPlateCarrier() {
		...
		platecarrier.cubeList.add(new ModelBox(platecarrier, 16, 40, -3.5F, 1.75F, -2.52F, 7, 9, 1, 0.0F, false));
		...
		setRotationAngle(cube_r4, -0.1222F, 0.0F, 0.2094F);
		...
		setRotationAngle(cube_r5, -0.1222F, 0.0F, -0.2094F);
		...
		cube_r12.setRotationPoint(-3.0F, 5.45F, -2.85F);
