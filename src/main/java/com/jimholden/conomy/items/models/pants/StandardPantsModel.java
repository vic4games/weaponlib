...
public class StandardPantsModel extends ModelBiped {
	...
	public StandardPantsModel() {
		...
		rightleg.cubeList.add(new ModelBox(rightleg, 0, 32, -1.9F, 0.0F, -2.0F, 4, 12, 4, 0.025F, false));

		leftleg = new ModelRenderer(this);
		leftleg.setRotationPoint(2.0F, 12.0F, 0.0F);
		leftleg.cubeList.add(new ModelBox(leftleg, 24, 24, -2.1F, 0.0F, -2.0F, 4, 12, 4, 0.025F, false));
