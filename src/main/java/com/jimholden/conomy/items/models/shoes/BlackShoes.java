...
public class BlackShoes extends ModelBiped {
	...
	public BlackShoes() {
		...
		leftshoe.setRotationPoint(2.0F, 12.0F, 0.0F);
		leftshoe.cubeList.add(new ModelBox(leftshoe, 20, 18, -1.999F, 11.0F, -2.35F, 4, 1, 1, 0.0F, false));

		rightshoe = new ModelRenderer(this);
		rightshoe.setRotationPoint(-2.0F, 12.0F, 0.0F);
		rightshoe.cubeList.add(new ModelBox(rightshoe, 20, 16, -2.001F, 11.0F, -2.35F, 4, 1, 1, 0.0F, false));
		
		bipedLeftArm.isHidden = true;
		bipedRightArm.isHidden = true;
		bipedBody.isHidden = true;
		bipedLeftLeg = leftshoe;
		bipedRightLeg = rightshoe;
