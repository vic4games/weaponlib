...
public abstract class GuiTestContainer extends GuiScreen
{
    ...
    public static final ResourceLocation BACKPACK_SLOT = new ResourceLocation(Reference.MOD_ID + ":textures/gui/customslots.png");
    ...
    public static final ScaledResolution scaledRes = new ScaledResolution(Minecraft.getMinecraft());
    ...
    public GuiTestContainer(Container inventorySlotsIn)
    {
    ...
    public void initGui()
    {
       ...
       // this.guiLeft = 0;
        ...
        //System.out.println("INITIAL: " + this.guiLeft + " | " + this.guiTop);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1)
        {
            ...
            if (this.isMouseOverSlot(slot, mouseX, mouseY) && slot.isEnabled())
            {
                ...
                if(!(slot instanceof CustomInvSlot)) {
                	this.drawGradientRect(j1, k1, j1 + 16, k1 + 16, -2130706433, -2130706433);
            	} else {
            		CustomInvSlot scalable = ((CustomInvSlot) slot);
            		this.drawGradientRect(j1, k1, j1 + scalable.getRenderSize(), k1 + scalable.getRenderSize(), -2130706433, -2130706433);
            	}
    ...
    private void drawSlot(Slot slotIn)
    {
        ...
        if(slotIn instanceof Slot && slotIn.getSlotIndex() >= 0 && slotIn.getSlotIndex() < 9 && slotIn.inventory == this.mc.player.inventory) {
        	GlStateManager.disableLighting();
        	GlStateManager.disableDepth();
        	...
        	GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        	this.drawTexturedModalRect(i, j, 16, 0, 16, 16);
        ...
        if(slotIn instanceof BackpackSlots || slotIn instanceof RigSlots) {
        	GlStateManager.disableLighting();
        	GlStateManager.disableDepth();
        	GlStateManager.enableTexture2D();
        ...
        if (itemstack.isEmpty() && slotIn.isEnabled())
        {
            ...
            {
            	if(!(slotIn instanceof CustomInvSlot)) {
            		GlStateManager.disableLighting();
            		...
            		CustomInvSlot scalable = ((CustomInvSlot) slotIn);
            		GlStateManager.disableLighting();
                    this.mc.getTextureManager().bindTexture(slotIn.getBackgroundLocation());
                    this.drawTexturedModalRect(i, j, textureatlassprite, scalable.getRenderSize(), scalable.getRenderSize());
                    GlStateManager.enableLighting();
                    flag1 = true;
            	}
        ...
        if (!flag1)
        {
            if (flag)
            {
            	if(!(slotIn instanceof CustomInvSlot)) {
            		...
            		CustomInvSlot custom = ((CustomInvSlot) slotIn);
            		drawRect(i, j, i + custom.getRenderSize(), j + custom.getRenderSize(), -2130706433);
            	}
            ...
            if(!(slotIn instanceof CustomInvSlot)) {
            	...
            	CustomInvSlot scaleable = ((CustomInvSlot) slotIn);
            	GlStateManager.pushMatrix();
            	GlStateManager.scale(scaleable.scale, scaleable.scale, scaleable.scale);
            	GlStateManager.enableDepth();
                this.itemRender.renderItemAndEffectIntoGUI(this.mc.player, itemstack, (int) (i/scaleable.scale), (int) (j/scaleable.scale));
                this.itemRender.renderItemOverlayIntoGUI(this.fontRenderer, itemstack, (int) (i/scaleable.scale), (int) (j/scaleable.scale), s);
    ...
    private boolean isMouseOverSlot(Slot slotIn, int mouseX, int mouseY)
    {
    	...
    	/*
    	boolean checker = this.isPointInRegion(slotIn.xPos, slotIn.yPos, 16, 16, mouseX, mouseY);
    	boolean fakeNews = !InventoryUtil.getRight(slotIn, this.inventorySlots);
    	...
    	*/
    	...
    	if(!(slotIn instanceof CustomInvSlot)) {
    		...
    		return this.isPointInRegion(slotIn.xPos, slotIn.yPos, ((CustomInvSlot) slotIn).getRenderSize(), ((CustomInvSlot) slotIn).getRenderSize(), mouseX, mouseY);
    	}
    	*/
