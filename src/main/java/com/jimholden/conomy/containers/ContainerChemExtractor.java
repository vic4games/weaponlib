...
public class ContainerChemExtractor extends Container {
	...
	public ContainerChemExtractor(InventoryPlayer player, TileEntityChemExtractor tileentity) {
		this.tileentity = tileentity;
		
		this.addSlotToContainer(new ChemMixingInputSlot(tileentity.handler, 0, 49, 33));
		this.addSlotToContainer(new ChemOutputSlot(tileentity.handler, 1, 92, 12));
		this.addSlotToContainer(new ChemOutputSlot(tileentity.handler, 2, 92, 33));
		this.addSlotToContainer(new ChemOutputSlot(tileentity.handler, 3, 92, 54));
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) 
	{
		...
		if(slot != null && slot.getHasStack()) 
		{
			...
			{
				if(!this.mergeItemStack(stack1, 0, 40, true)) return ItemStack.EMPTY;
			...
			else if(!this.mergeItemStack(stack1, 0, 40, false)) 
			{
