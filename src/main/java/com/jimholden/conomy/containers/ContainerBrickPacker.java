...
public class ContainerBrickPacker extends Container {
	...
	public ContainerBrickPacker(InventoryPlayer player, TileEntityBrickPacker tileEntityBrickPacker) {
		this.tileentity = tileEntityBrickPacker;
		
		this.addSlotToContainer(new CompInputSlot(tileEntityBrickPacker.handler, 0, 23, 33));
		this.addSlotToContainer(new PackingMatInputSlot(tileEntityBrickPacker.handler, 1, 49, 33));
		this.addSlotToContainer(new ChemOutputSlot(tileEntityBrickPacker.handler, 2, 92, 33));
