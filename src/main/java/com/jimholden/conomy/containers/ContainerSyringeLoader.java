...
public class ContainerSyringeLoader extends Container {
	...
	public ContainerSyringeLoader(InventoryPlayer player, TileEntitySyringeLoader tileentity) {
		this.tileentity = tileentity;
		
		this.addSlotToContainer(new CompInputSlot(tileentity.handler, 0, 11, 32));
		this.addSlotToContainer(new CuttingAgentSlot(tileentity.handler, 1, 48, 32));
		this.addSlotToContainer(new ChemOutputSlot(tileentity.handler, 2, 101, 32));
